export const GetClassDescription = {description: "Get data by class_id"}
export const GetClassParam = { name: 'id', type: 'string', example: '26cc5a2e-5ff3-4def-a927-e0fbb3349756'}

export const GetClassSuccess = {
    description: 'Success get class data', 
    schema: {
        type: 'object',
        properties: {
            status_code: {type: 'number', example: 200},
            message: {type: 'string', example: 'Success get class data'},
            data: {
                type: 'object',
                properties: {
...
export const GetClassInternalServerError = {
