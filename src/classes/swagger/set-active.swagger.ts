export const SetActiveClassDescription = {description: "Set active by class_id"}
export const SetActiveClassParam = { name: 'id', type: 'string', example: '26cc5a2e-5ff3-4def-a927-e0fbb3349756'}

export const SetActiveClassSuccess = {
    description: 'Success set active class data',  
    schema: {
        type: 'object',
        properties: {
            status_code: {type: 'number', example: 200},
            message: {type: 'string', example: `Success set active class data with class_id: 26cc5a2e-5ff3-4def-a927-e0fbb3349756`},
            data: {
                type: 'object',
                properties: {
...
export const SetActiveClassNotFound = {
...
export const SetActiveClassInternalServerError = {
